...
function findVideo($request_string){
    ...
    $api = get_ydata('https://www.googleapis.com/youtube/v3/search?part=snippet&q='.$clear_request_string.'&maxResults=20&key='.KEY_YOUTUBE); // спарсили файл с информацией о видео
